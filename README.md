...
| :--- | :--- | :---: |
| 🧠 **Эмуляция CPU** | Полная поддержка системы команд архитектуры **PDP-11**. | `MOV`, `ADD`, `SOB`, `BR` и др.|
...
## Для запуска модульных тестов и значений регистров при выполнении каждой команды:
```bash
...
## Pеализованы основные инструкции:
